    ...
    implicit none
    integer, parameter :: MAXITER=1000000,MAXJ=1000
    dimension g(MAXJ+1)
    real(dl) f
    external f
    real(dl) :: rombint2
...
500 continue
    ...
    integer, parameter :: ITERMAX=1000000 ! max number of iteration
    real(dl), parameter :: tol=1.e-12_dl ! tolerance for error
